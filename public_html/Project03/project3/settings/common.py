...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', ')w4+6v6n8auo&!&a7r4nv9l+5@o1-wl4^e+ptz@rf*kjp8#@1_')
...
# See .ebextensions/project3.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'project3.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
